...
public class AppsWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.example.bangkumist.moviecatalogue.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.bangkumist.moviecatalogue.EXTRA_ITEM";
